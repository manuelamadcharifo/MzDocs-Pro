...
## 2. Diplomas confirmados como correctos (sem alteração)
...
| Lei n.º 8/2004, de 21 de Julho (Registos e Identificação Civil) | `requerimento.js` | Confirmado contra `Mozambique_Lei_8_2004.pdf`. |
