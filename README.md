...
> fases): fraude
> em comprovativos de pagamento (hash SHA-256 da imagem completa, hoje só os primeiros 5000
> caracteres do base64 — `api/_services/payments.js`, confirmado mas não corrigido), P1.7
