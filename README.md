...
> código-fonte no export mais recente. A versão anterior deste ficheiro não cobria a ronda mais
> recente: correcção de um bug real reportado por captura de ecrã — depois de criar conta, o
> "primeiro documento grátis" da v66 (`migration_v66_first_document_free.sql`,
...
> "Set/2026 (ronda actual)" na secção 15 para o detalhe completo por ficheiro.
