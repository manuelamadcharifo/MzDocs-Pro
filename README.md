...
>
> **Pendente desta mesma ronda de hardening** (não coberto ainda — ver secção 15 para o plano por
> fases): P1.7
> (OCR/privacidade), P1.8 (XSS no feedback), P1.9 (fact-check do SEO), P1.11 (contabilidade
> económica no Admin). Custo de "planonegocio" (Plano de Negócios) permanece com o rótulo fixo
> antigo (2 créditos) sem estimativa dinâmica — não tem campo de páginas do qual a derivar; risco
> residual menor, não corrigido nesta ronda.
>
...
### 6.3. Migrações Supabase — lista completa e actualizada (v8 → v69)
