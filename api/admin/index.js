  ...
  try {
    ...
    if (req.method === 'GET') {
      ...
      let q = supabase.from('templates_custom')
        .select('id, user_id, service_type, template_name, description, template_type, status, is_featured, is_public, credit_cost, price_mzn, author_share_percent, use_count, downloads, avg_rating, rejection_note, template_html, template_css, created_at')
