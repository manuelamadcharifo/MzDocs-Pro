...
export const SERVICES = {
  ...
  trabalho: {
    ...
    fields:[
      ...
      { id:'paginas',    label:'Páginas de desenvolvimento pretendidas', type:'number', val:'5', min:'2', max:'30',
        hint:'Só as páginas de desenvolvimento (capítulos) — capa, folha de rosto, índice, introdução, conclusão e referências são sempre acrescentadas à parte.' },
      { id:'extras',     label:'Secções extra (opcional)', type:'select',
        opts:['Nenhuma','Dedicatória','Agradecimentos','Dedicatória e Agradecimentos','Epígrafe','Dedicatória, Agradecimentos e Epígrafe'] },
