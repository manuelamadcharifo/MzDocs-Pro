...
BASE LEGAL (verificada contra fontes oficiais em Junho/2026 — ver /docs/legal/VERIFICACAO-LEGAL.md):
- Código Civil de Moçambique, artigos 262.º a 294.º (Representação e Procuração)
- Código do Notariado de Moçambique (Decreto-Lei n.º 4/2006, de 23 de Agosto, que altera e republica o Código do Notariado), artigo 120.º (Procurações e substabelecimentos)
${isBancaria ? '- Aviso n.º 01/GBM/2017 do Banco de Moçambique (procurações bancárias)' : ''}
${isImóvel ? '- Código Civil de Moçambique (regras gerais sobre transmissão de imóveis); reconhecimento notarial obrigatório nos termos do artigo 120.º do Código do Notariado. NÃO citar uma "Lei n.º 19/2013" de negócios imobiliários — essa referência não foi confirmada em nenhuma fonte oficial' : ''}
${isJudicial ? '- Código de Processo Civil de Moçambique; Estatuto da Ordem dos Advogados (Lei n.º 7/94, de 14 de Setembro)' : ''}
...
2. Para procuração sobre imóveis: reconhecimento notarial é SEMPRE obrigatório (art. 120.º do Código do Notariado — Procurações e substabelecimentos)
...
Reconheço a assinatura aposta neste documento como sendo do próprio punho de **${data.outorgante}**, nos termos do artigo 120.º do Código do Notariado de Moçambique.
